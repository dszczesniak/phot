"""
Django settings for projectphoto project.
...
SECRET_KEY = '%o6bn)yxb8_fjw=b6af)ck_z+ev36sz$gtm%@a$%)l%+%37!yv'
...
ROOT_URLCONF = 'projectphoto.urls'
...
WSGI_APPLICATION = 'projectphoto.wsgi.application'
