...
from .managers import GalleryQuerySet, PhotoQuerySet, FamilyQuerySet
...
SAMPLE_SIZE = getattr(settings, 'PHOTOLOGUE_GALLERY_SAMPLE_SIZE', 9)
...
class Gallery(models.Model):
    ...
    description = models.TextField(_('description'),
                                   blank=True)
    cats = models.TextField(_('kategoria_albumu'),
                                    max_length=3,
                                    default='A',
                                    help_text=_('Wybierz kategorie dla albumu: R - rodzinne | N - noworodkowe | O - okazjonalne | C - ciazowe | 365 - projekt365'))
...
class Family(models.Model):
    ...
    is_public = models.BooleanField(_('is public'),
                                    default=True,
                                    help_text=_('Public families will be displayed '
                                                'in the default views.'))
    photos = SortedManyToManyField('photologue.Photo',
    ...
    def get_absolute_url(self):
        return reverse('photologue:pl-family', args=[self.slug])
